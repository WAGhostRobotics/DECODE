...
public class Brushland extends LinearOpMode {
    ...
    public static double highb0;
    public static double highb1;
    @Override
    public void runOpMode() throws InterruptedException {
        ColorRangefinder crf = new ColorRangefinder(hardwareMap.get(RevColorSensorV3.class, "intakeDistance"));
        ...
        waitForStart();
            ...
            crf.setPin0Digital(ColorRangefinder.DigitalMode.DISTANCE, 0, highb0);
            crf.setPin1Digital(ColorRangefinder.DigitalMode.DISTANCE, 0, highb1);
    }
}
