...
@Autonomous
public class Red15 extends LinearOpMode {
    ElapsedTime timer;
    ...
    public static Point openGate = new Point(74, 26.3);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        scheduler.init();
        while (opModeInInit()) {
            Gus.shooter.setTurretTargetPos(Shooter.angleToPosition(-136));
    ...
    private SequentialCommand getSequentialCommand() {
        SequentialCommand scheduler = new SequentialCommand(
                ...
                new ParallelCommand(
                        new RunCommand(()-> Gus.shooter.setTurretTargetPos(Shooter.angleToPosition(-136)))
                ),
                new ScoreThreeArtifacts(follower, shootPath, 171, Shooter.angleToPosition(-136), 0.35),

                new ParallelCommand(
                        new FollowTrajectory(follower, spike2intake),
                        new CollectSpikesV3(follower)
                ),
                new ScoreThreeArtifacts(follower, spike2ToShoot, 171, Shooter.angleToPosition(-136), 0.35),
...
//                new ScoreThreeArtifacts(follower, spike2ToShoot, 176, Shooter.angleToPosition(-129), 0.34),
                ...
                new ScoreThreeArtifacts(follower, spike1ToShoot, 171, Shooter.angleToPosition(-136), 0.35),
