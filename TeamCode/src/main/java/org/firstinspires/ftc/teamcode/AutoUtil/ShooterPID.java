...
public class ShooterPID {
    ...
    private final double vTun = 13.0;
    private double vCur;
     ...
     */
    public ShooterPID(double kp, double ki, double kd, double kf, double ks) {
        this(kp, ki, kd, kf, ks, 0, 0);
    }
     ...
     */
    public ShooterPID(double kp, double ki, double kd, double kf, double ks, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
    ...
    public double calculate(double pv) {
        ...
        // returns u(t)
        return (kP * errorVal_p + kI * totalError + kD * errorVal_v + kF * setPoint + Math.signum(setPoint)*kS) * (vTun/vCur);
    }

    public void setPIDFS(double kp, double ki, double kd, double kf, double ks) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
