...
public class Red18 extends OpMode {
    private final Logger log = LoggerFactory.getLogger(RedGateAuto.class);
    File file;
    ...
    public Point spike3 = new Point(96, -5.27);
    public Point spike2take = new Point(71.2, 27.5);// **
    ...
    public void init() {
        ...
        spike2ToShoot = new MergedBezier(
                ...
                new Bezier(
                        90,
                        openGateSpike,
                        new Point(spike2.getX()-10, spike2.getY() + 15)
                ),
                new Bezier(
                        90,
                        new Point(spike2.getX()-10, spike2.getY() + 15),
